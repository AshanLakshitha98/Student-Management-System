...
namespace Student_Management_System.Screens
{
    public partial class frmChangePassword : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = "select * from TableLogin where Studentid='" + frmLogin.useridpassing + "'";
                            ...
                            else
                            {
                                ...
                                if (diRes == DialogResult.Yes)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        sql = "update TableLogin set Password='" + txtNew.Text + "' where Studentid='" + frmLogin.useridpassing + "'";
